<template>
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
       ...
       <div >
        <img class="mx-auto h-12 w-auto" src="/logo/logo.png" alt="Hookers" />
            <h2 class="mt-6 text-center text-3xl font-extrabold text-white">Recover your account</h2>
            
          </div>
          <form class="mt-8 space-y-6" @submit="recover">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
    ...
    function recover(ev) {
      ...
      store.dispatch("auth/forgotPassword", user)
        .then((res) => {
          loading.value = false;
          store.commit("notify", {
              type: "success",
              message: `Verification code sent to your email, check`,
            });
