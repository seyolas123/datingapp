            ...
            <div class="flex items-center justify-between w-3/4 p-3 border-t border-gray-300">
                ...
                <div class="flex justify-center">
                  <input 
                    ...
                    style="width:40vh;"
                    autocomplete="off"
                    class="mt-1 mb-3 block w-full py-2 px-3 border border-lime-900 bg-white shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
